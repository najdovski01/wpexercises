...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .defaultSuccessUrl("/employees", true).and()
                .logout()
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        //koj provider ker go koristime, sega ke koristime inmemory authentication
        auth.inMemoryAuthentication()
                .withUser("employee.2@wp.finki.ukim.mk")
                .password(passwordEncoder.encode("emp2"))
                .authorities("ROLE_USER")
                .and()
                .withUser("employee.1@wp.finki.ukim.mk")
